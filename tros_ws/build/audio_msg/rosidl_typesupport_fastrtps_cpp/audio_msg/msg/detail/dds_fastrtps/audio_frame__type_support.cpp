...
#include "audio_msg/msg/detail/audio_frame__rosidl_typesupport_fastrtps_cpp.hpp"
...
{
bool cdr_serialize(
  const audio_msg::msg::AudioFrameType &,
  eprosima::fastcdr::Cdr &);
bool cdr_deserialize(
  eprosima::fastcdr::Cdr &,
...
{
bool cdr_serialize(
  const audio_msg::msg::SmartAudioData &,
  eprosima::fastcdr::Cdr &);
bool cdr_deserialize(
  eprosima::fastcdr::Cdr &,
  ...
  size_t current_alignment)
{
  ...
  // Member: frame_type
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        audio_msg::msg::typesupport_fastrtps_cpp::max_serialized_size_AudioFrameType(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  // Member: smart_audio
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        audio_msg::msg::typesupport_fastrtps_cpp::max_serialized_size_SmartAudioData(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  if (is_plain) {
    ...
    using DataType = audio_msg::msg::AudioFrame;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const audio_msg::msg::AudioFrame *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<audio_msg::msg::AudioFrame *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _AudioFrame__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const audio_msg::msg::AudioFrame *>(
...
static size_t _AudioFrame__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_AudioFrame(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _AudioFrame__callbacks = {
  "audio_msg::msg",
  "AudioFrame",
...
static rosidl_message_type_support_t _AudioFrame__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_AudioFrame__callbacks,
...
{
  return &audio_msg::msg::typesupport_fastrtps_cpp::_AudioFrame__handle;
}
