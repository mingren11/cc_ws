...
bool ai_msgs__msg__capture__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("ai_msgs.msg._capture.Capture", full_classname_dest, 28) == 0);
  }
  ai_msgs__msg__Capture * ros_message = _ros_message;
  {  // header
  ...
  {  // db_result
    PyObject * field = PyObject_GetAttrString(_pymsg, "db_result");
    if (!field) {
      return false;
    }
    if (!ai_msgs__msg__db_result__convert_from_py(field, &ros_message->db_result)) {
      Py_DECREF(field);
      return false;
    }
    Py_DECREF(field);
...
{
  /* NOTE(esteve): Call constructor of Capture */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("ai_msgs.msg._capture");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "Capture");
  ...
  {  // db_result
    PyObject * field = NULL;
    field = ai_msgs__msg__db_result__convert_to_py(&ros_message->db_result);
    if (!field) {
      return NULL;
    }
    {
      int rc = PyObject_SetAttrString(_pymessage, "db_result", field);
      Py_DECREF(field);
      if (rc) {
        return NULL;
      }
