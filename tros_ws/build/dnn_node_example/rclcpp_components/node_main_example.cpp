...
#define NODE_MAIN_LOGGER_NAME "example"
...
int main(int argc, char * argv[])
{
  ...
  std::string library_name = "libdnn_node_example_component.so";
  std::string class_name = "rclcpp_components::NodeFactoryTemplate<DnnExampleNode>";
