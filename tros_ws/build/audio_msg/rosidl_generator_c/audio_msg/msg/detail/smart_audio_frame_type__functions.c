...
audio_msg__msg__SmartAudioFrameType__create()
{
  ...
  audio_msg__msg__SmartAudioFrameType * msg = (audio_msg__msg__SmartAudioFrameType *)allocator.allocate(sizeof(audio_msg__msg__SmartAudioFrameType), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(audio_msg__msg__SmartAudioFrameType));
  bool success = audio_msg__msg__SmartAudioFrameType__init(msg);
  if (!success) {
...
audio_msg__msg__SmartAudioFrameType__destroy(audio_msg__msg__SmartAudioFrameType * msg)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (msg) {
    audio_msg__msg__SmartAudioFrameType__fini(msg);
  }
  allocator.deallocate(msg, allocator.state);
}
...
audio_msg__msg__SmartAudioFrameType__Sequence__init(audio_msg__msg__SmartAudioFrameType__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  audio_msg__msg__SmartAudioFrameType * data = NULL;

  if (size) {
    data = (audio_msg__msg__SmartAudioFrameType *)allocator.zero_allocate(size, sizeof(audio_msg__msg__SmartAudioFrameType), allocator.state);
    if (!data) {
      return false;
    }
    ...
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = audio_msg__msg__SmartAudioFrameType__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      ...
      for (; i > 0; --i) {
        audio_msg__msg__SmartAudioFrameType__fini(&data[i - 1]);
      }
...
audio_msg__msg__SmartAudioFrameType__Sequence__fini(audio_msg__msg__SmartAudioFrameType__Sequence * array)
{
  ...
  if (array->data) {
    ...
    for (size_t i = 0; i < array->capacity; ++i) {
      audio_msg__msg__SmartAudioFrameType__fini(&array->data[i]);
    }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  audio_msg__msg__SmartAudioFrameType__Sequence * array = (audio_msg__msg__SmartAudioFrameType__Sequence *)allocator.allocate(sizeof(audio_msg__msg__SmartAudioFrameType__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = audio_msg__msg__SmartAudioFrameType__Sequence__init(array, size);
  if (!success) {
...
audio_msg__msg__SmartAudioFrameType__Sequence__destroy(audio_msg__msg__SmartAudioFrameType__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    audio_msg__msg__SmartAudioFrameType__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
audio_msg__msg__SmartAudioFrameType__Sequence__are_equal(const audio_msg__msg__SmartAudioFrameType__Sequence * lhs, const audio_msg__msg__SmartAudioFrameType__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!audio_msg__msg__SmartAudioFrameType__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  audio_msg__msg__SmartAudioFrameType__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(audio_msg__msg__SmartAudioFrameType);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    audio_msg__msg__SmartAudioFrameType * data =
      (audio_msg__msg__SmartAudioFrameType *)allocator.reallocate(
    ...
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!audio_msg__msg__SmartAudioFrameType__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          audio_msg__msg__SmartAudioFrameType__fini(&output->data[i]);
        }
        return false;
      }
    }
