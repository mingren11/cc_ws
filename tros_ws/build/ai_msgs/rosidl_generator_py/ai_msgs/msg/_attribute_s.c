...
bool ai_msgs__msg__attribute__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("ai_msgs.msg._attribute.Attribute", full_classname_dest, 32) == 0);
  }
  ai_msgs__msg__Attribute * ros_message = _ros_message;
  {  // type
...
{
  /* NOTE(esteve): Call constructor of Attribute */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("ai_msgs.msg._attribute");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "Attribute");
