...
static const _AudioEventType_type_support_symbol_names_t _AudioEventType_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, audio_msg, msg, AudioEventType)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, audio_msg, msg, AudioEventType)),
  }
};
...
{
  return &::audio_msg::msg::rosidl_typesupport_cpp::AudioEventType_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, audio_msg, msg, AudioEventType)() {
  return get_message_type_support_handle<audio_msg::msg::AudioEventType>();
}
