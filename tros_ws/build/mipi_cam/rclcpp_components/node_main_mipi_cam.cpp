...
#define NODE_MAIN_LOGGER_NAME "mipi_cam"
...
int main(int argc, char * argv[])
{
  ...
  std::string library_name = "libmipi_cam_plugin.so";
  std::string class_name = "rclcpp_components::NodeFactoryTemplate<mipi_cam::MipiCamNode>";
