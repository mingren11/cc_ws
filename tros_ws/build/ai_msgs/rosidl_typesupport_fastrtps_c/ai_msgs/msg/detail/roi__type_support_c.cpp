...
#include "ai_msgs/msg/detail/roi__rosidl_typesupport_fastrtps_c.h"
...
#include "sensor_msgs/msg/detail/region_of_interest__functions.h"  // rect
...
using _Roi__ros_msg_type = ai_msgs__msg__Roi;
...
static uint32_t _Roi__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_ai_msgs__msg__Roi(
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = ai_msgs__msg__Roi;
    is_plain =
      (
...
static size_t _Roi__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_ai_msgs__msg__Roi(
