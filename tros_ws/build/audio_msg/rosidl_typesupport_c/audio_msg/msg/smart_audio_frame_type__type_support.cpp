...
static const _SmartAudioFrameType_type_support_symbol_names_t _SmartAudioFrameType_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, audio_msg, msg, SmartAudioFrameType)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, audio_msg, msg, SmartAudioFrameType)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, audio_msg, msg, SmartAudioFrameType)() {
  return &::audio_msg::msg::rosidl_typesupport_c::SmartAudioFrameType_message_type_support_handle;
}
