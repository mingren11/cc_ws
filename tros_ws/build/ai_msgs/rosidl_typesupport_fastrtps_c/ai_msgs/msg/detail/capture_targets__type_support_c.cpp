...
#include "ai_msgs/msg/detail/capture_targets__rosidl_typesupport_fastrtps_c.h"
...
#include "ai_msgs/msg/detail/target__functions.h"  // targets
...
using _CaptureTargets__ros_msg_type = ai_msgs__msg__CaptureTargets;

static bool _CaptureTargets__cdr_serialize(
  const void * untyped_ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const _CaptureTargets__ros_msg_type * ros_message = static_cast<const _CaptureTargets__ros_msg_type *>(untyped_ros_message);
  // Field name: header
  {
...
static bool _CaptureTargets__cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  void * untyped_ros_message)
{
  ...
  _CaptureTargets__ros_msg_type * ros_message = static_cast<_CaptureTargets__ros_msg_type *>(untyped_ros_message);
  // Field name: header
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
...
static uint32_t _CaptureTargets__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_ai_msgs__msg__CaptureTargets(
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = ai_msgs__msg__CaptureTargets;
    is_plain =
      (
...
static size_t _CaptureTargets__max_serialized_size(char & bounds_info)
{
  bool full_bounded;
  bool is_plain;
  size_t ret_val;

  ret_val = max_serialized_size_ai_msgs__msg__CaptureTargets(
...
static message_type_support_callbacks_t __callbacks_CaptureTargets = {
  "ai_msgs::msg",
  "CaptureTargets",
  _CaptureTargets__cdr_serialize,
  _CaptureTargets__cdr_deserialize,
  _CaptureTargets__get_serialized_size,
  _CaptureTargets__max_serialized_size
};

static rosidl_message_type_support_t _CaptureTargets__type_support = {
  rosidl_typesupport_fastrtps_c__identifier,
  &__callbacks_CaptureTargets,
  get_message_typesupport_handle_function,
};

const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, ai_msgs, msg, CaptureTargets)() {
  return &_CaptureTargets__type_support;
}
