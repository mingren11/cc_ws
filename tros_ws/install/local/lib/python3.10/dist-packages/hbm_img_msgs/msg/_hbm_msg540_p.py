...
class Metaclass_HbmMsg540P(type):
    """Metaclass of message 'HbmMsg540P'."""
    ...
    def __import_type_support__(cls):
        try:
            ...
            logger = logging.getLogger(
                'hbm_img_msgs.msg.HbmMsg540P')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
            cls._CREATE_ROS_MESSAGE = module.create_ros_message_msg__msg__hbm_msg540_p
            cls._CONVERT_FROM_PY = module.convert_from_py_msg__msg__hbm_msg540_p
            cls._CONVERT_TO_PY = module.convert_to_py_msg__msg__hbm_msg540_p
            cls._TYPE_SUPPORT = module.type_support_msg__msg__hbm_msg540_p
            cls._DESTROY_ROS_MESSAGE = module.destroy_ros_message_msg__msg__hbm_msg540_p
    ...
    def MAX_SIZE(self):
        ...
        return Metaclass_HbmMsg540P.__constants['MAX_SIZE']


class HbmMsg540P(metaclass=Metaclass_HbmMsg540P):
    """
    Message class 'HbmMsg540P'.
    ...
    SLOT_TYPES = (
        ...
        rosidl_parser.definition.Array(rosidl_parser.definition.BasicType('uint8'), 1555200),  # noqa: E501
    )
    ...
    def __init__(self, **kwargs):
        ...
        if 'data' not in kwargs:
            self.data = numpy.zeros(1555200, dtype=numpy.uint8)
        else:
            self.data = numpy.array(kwargs.get('data'), dtype=numpy.uint8)
            assert self.data.shape == (1555200, )
    ...
    def data(self, value):
        if isinstance(value, numpy.ndarray):
            ...
            assert value.size == 1555200, \
                "The 'data' numpy.ndarray() must have a size of 1555200"
            self._data = value
            return
        if __debug__:
            from collections.abc import Sequence
            ...
            assert \
                ((isinstance(value, Sequence) or
                 ...
                 not isinstance(value, str) and
                 not isinstance(value, UserString) and
                 len(value) == 1555200 and
                 all(isinstance(v, int) for v in value) and
                 all(val >= 0 and val < 256 for val in value)), \
                "The 'data' field must be a set or sequence with length 1555200 and each value of type 'int' and each unsigned integer in [0, 255]"
