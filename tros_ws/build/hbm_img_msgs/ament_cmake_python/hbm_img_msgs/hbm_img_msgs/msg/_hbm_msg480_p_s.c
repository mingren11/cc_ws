...
bool hbm_img_msgs__msg__hbm_msg480_p__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("hbm_img_msgs.msg._hbm_msg480_p.HbmMsg480P", full_classname_dest, 41) == 0);
  }
  hbm_img_msgs__msg__HbmMsg480P * ros_message = _ros_message;
  {  // index
...
{
  /* NOTE(esteve): Call constructor of HbmMsg480P */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("hbm_img_msgs.msg._hbm_msg480_p");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "HbmMsg480P");
