...
#define NODE_MAIN_LOGGER_NAME "hobot_rtsp_client"
...
int main(int argc, char * argv[])
{
  ...
  std::string library_name = "libhobot_rtsp_client_component.so";
  std::string class_name = "rclcpp_components::NodeFactoryTemplate<HobotRtspClientNode>";
