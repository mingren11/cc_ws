...
#define NODE_MAIN_LOGGER_NAME "stereonet_model_intra_sub_node"
...
int main(int argc, char * argv[])
{
  ...
  std::string library_name = "libstereonet_model_intra_sub.so";
  std::string class_name = "rclcpp_components::NodeFactoryTemplate<stereonet::StereoNetSubNode>";
