...
#define NODE_MAIN_LOGGER_NAME "mono2d_body_detection"
...
int main(int argc, char * argv[])
{
  ...
  std::string library_name = "libmono2d_body_detection_component.so";
  std::string class_name = "rclcpp_components::NodeFactoryTemplate<Mono2dBodyDetNode>";
