...
class Metaclass_H26XFrame(type):
    """Metaclass of message 'H26XFrame'."""
    ...
    def __import_type_support__(cls):
        try:
            ...
            module = import_type_support('img_msgs')
        except ImportError:
            import logging
            import traceback
            logger = logging.getLogger(
                'img_msgs.msg.H26XFrame')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
            cls._CREATE_ROS_MESSAGE = module.create_ros_message_msg__msg__h26_x_frame
            cls._CONVERT_FROM_PY = module.convert_from_py_msg__msg__h26_x_frame
            cls._CONVERT_TO_PY = module.convert_to_py_msg__msg__h26_x_frame
            cls._TYPE_SUPPORT = module.type_support_msg__msg__h26_x_frame
            cls._DESTROY_ROS_MESSAGE = module.destroy_ros_message_msg__msg__h26_x_frame
...
class H26XFrame(metaclass=Metaclass_H26XFrame):
    """Message class 'H26XFrame'."""
