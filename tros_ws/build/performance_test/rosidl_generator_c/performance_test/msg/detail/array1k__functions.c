...
performance_test__msg__Array1k__create()
{
  ...
  performance_test__msg__Array1k * msg = (performance_test__msg__Array1k *)allocator.allocate(sizeof(performance_test__msg__Array1k), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(performance_test__msg__Array1k));
  bool success = performance_test__msg__Array1k__init(msg);
  if (!success) {
...
performance_test__msg__Array1k__destroy(performance_test__msg__Array1k * msg)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (msg) {
    performance_test__msg__Array1k__fini(msg);
  }
  allocator.deallocate(msg, allocator.state);
}
...
performance_test__msg__Array1k__Sequence__init(performance_test__msg__Array1k__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  performance_test__msg__Array1k * data = NULL;

  if (size) {
    data = (performance_test__msg__Array1k *)allocator.zero_allocate(size, sizeof(performance_test__msg__Array1k), allocator.state);
    if (!data) {
      return false;
    }
    ...
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = performance_test__msg__Array1k__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      ...
      for (; i > 0; --i) {
        performance_test__msg__Array1k__fini(&data[i - 1]);
      }
...
performance_test__msg__Array1k__Sequence__fini(performance_test__msg__Array1k__Sequence * array)
{
  ...
  if (array->data) {
    ...
    for (size_t i = 0; i < array->capacity; ++i) {
      performance_test__msg__Array1k__fini(&array->data[i]);
    }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  performance_test__msg__Array1k__Sequence * array = (performance_test__msg__Array1k__Sequence *)allocator.allocate(sizeof(performance_test__msg__Array1k__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = performance_test__msg__Array1k__Sequence__init(array, size);
  if (!success) {
...
performance_test__msg__Array1k__Sequence__destroy(performance_test__msg__Array1k__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    performance_test__msg__Array1k__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
performance_test__msg__Array1k__Sequence__are_equal(const performance_test__msg__Array1k__Sequence * lhs, const performance_test__msg__Array1k__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!performance_test__msg__Array1k__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  performance_test__msg__Array1k__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(performance_test__msg__Array1k);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    performance_test__msg__Array1k * data =
      (performance_test__msg__Array1k *)allocator.reallocate(
    ...
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!performance_test__msg__Array1k__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          performance_test__msg__Array1k__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  for (size_t i = 0; i < input->size; ++i) {
    if (!performance_test__msg__Array1k__copy(
