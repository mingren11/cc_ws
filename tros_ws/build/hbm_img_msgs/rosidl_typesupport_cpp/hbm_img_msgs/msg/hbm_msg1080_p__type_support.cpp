...
static const _HbmMsg1080P_type_support_symbol_names_t _HbmMsg1080P_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, hbm_img_msgs, msg, HbmMsg1080P)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, hbm_img_msgs, msg, HbmMsg1080P)),
  }
};
...
{
  return &::hbm_img_msgs::msg::rosidl_typesupport_cpp::HbmMsg1080P_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, hbm_img_msgs, msg, HbmMsg1080P)() {
  return get_message_type_support_handle<hbm_img_msgs::msg::HbmMsg1080P>();
}
