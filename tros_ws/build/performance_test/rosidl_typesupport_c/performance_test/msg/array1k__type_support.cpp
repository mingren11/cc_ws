...
static const _Array1k_type_support_symbol_names_t _Array1k_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, performance_test, msg, Array1k)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, performance_test, msg, Array1k)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, performance_test, msg, Array1k)() {
  return &::performance_test::msg::rosidl_typesupport_c::Array1k_message_type_support_handle;
}
