...
class Metaclass_TopicManage_Request(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            module = import_type_support('tros_perception_fusion_msgs')
        except ImportError:
            import logging
            import traceback
...
class Metaclass_TopicManage(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'tros_perception_fusion_msgs.srv.TopicManage')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
            ...
            from tros_perception_fusion_msgs.srv import _topic_manage
...
class TopicManage(metaclass=Metaclass_TopicManage):
    from tros_perception_fusion_msgs.srv._topic_manage import TopicManage_Request as Request
    from tros_perception_fusion_msgs.srv._topic_manage import TopicManage_Response as Response
