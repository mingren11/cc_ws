...
#define NODE_MAIN_LOGGER_NAME "tros_perception_fusion"
...
int main(int argc, char * argv[])
{
  ...
  std::string library_name = "libtros_perception_fusion_component.so";
  std::string class_name = "rclcpp_components::NodeFactoryTemplate<tros::TrosPerceptionMsgFusionNode>";
