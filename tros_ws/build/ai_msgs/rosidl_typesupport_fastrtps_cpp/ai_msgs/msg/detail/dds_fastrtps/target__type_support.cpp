...
#include "ai_msgs/msg/detail/target__rosidl_typesupport_fastrtps_cpp.hpp"
...
{
bool cdr_serialize(
  const ai_msgs::msg::Attribute &,
  eprosima::fastcdr::Cdr &);
bool cdr_deserialize(
  eprosima::fastcdr::Cdr &,
  ai_msgs::msg::Attribute &);
size_t get_serialized_size(
  const ai_msgs::msg::Attribute &,
  size_t current_alignment);
size_t
  ...
  ai_msgs::msg::Target & ros_message)
{
  ...
  // Member: captures
  {
    ...
    cdr >> cdrSize;
    size_t size = static_cast<size_t>(cdrSize);
    ros_message.captures.resize(size);
    for (size_t i = 0; i < size; i++) {
      ai_msgs::msg::typesupport_fastrtps_cpp::cdr_deserialize(
        cdr, ros_message.captures[i]);
    }
  }
  ...
  size_t current_alignment)
{
  ...
  // Member: captures
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment +=
        ai_msgs::msg::typesupport_fastrtps_cpp::get_serialized_size(
        ros_message.captures[index], current_alignment);
    }
  }
  ...
  size_t current_alignment)
{
  ...
  // Member: rois
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        ai_msgs::msg::typesupport_fastrtps_cpp::max_serialized_size_Roi(
  ...
  // Member: attributes
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        ai_msgs::msg::typesupport_fastrtps_cpp::max_serialized_size_Attribute(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  // Member: points
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        ai_msgs::msg::typesupport_fastrtps_cpp::max_serialized_size_Point(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  // Member: captures
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        ai_msgs::msg::typesupport_fastrtps_cpp::max_serialized_size_Capture(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  if (is_plain) {
    ...
    using DataType = ai_msgs::msg::Target;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const ai_msgs::msg::Target *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<ai_msgs::msg::Target *>(
    untyped_ros_message);
...
{
  return &ai_msgs::msg::typesupport_fastrtps_cpp::_Target__handle;
}
