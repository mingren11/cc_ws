    ...
    return LaunchDescription([
        ...
        Node(
            ...
            parameters=[
                ...
                # d435
                {'camera.fx': 326.533447265625},
                {'camera.cx': 318.5863037109375},
                {'camera.fy': 326.533447265625},
                {'camera.cy': 179.10447692871094},
                ...
                {'grid_map.min_obstacle_height': 0.15},
                {'grid_map.max_obstacle_height': 0.6},
                ...
                {'grid_map.cut_lower_ratio': 0.8},
                {'grid_map.min_occupancy_log': 0.7},
                {'grid_map.clear_map_factor': 100.0},
                #{'grid_map.static_map_path': 'src/ground_robot_planner/tools/python/yishang_1st.pgm'},
                {'grid_map.static_map_path': 'src/ground_robot_planner/tools/python/generate_png_from_plys/programs/suanli.pgm'},
                {'grid_map.static_map_min_east': 238264.9},
                {'grid_map.static_map_min_north': 3358331.339},
                ...
                {'controller.control_rate': 30.0},
                {'follower.lookahead_distance': 1.5},
                {'follower.lookahead_distance_factor': 1.0},
                {'follower.target_reached_threshold': 0.8},
                {'follower.max_x_velocity': 1.0},
                {'follower.max_y_velocity': 1.0},
                {'follower.max_angular_velocity': 0.8},
                {'follower.slowdown_distance': 0.8},
                {'follower.robot_radius': 0.1},
