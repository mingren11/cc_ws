...
bool ai_msgs__msg__roi__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("ai_msgs.msg._roi.Roi", full_classname_dest, 20) == 0);
  }
  ai_msgs__msg__Roi * ros_message = _ros_message;
  {  // type
  ...
  {  // rect
    PyObject * field = PyObject_GetAttrString(_pymsg, "rect");
    if (!field) {
      return false;
    }
    if (!sensor_msgs__msg__region_of_interest__convert_from_py(field, &ros_message->rect)) {
      Py_DECREF(field);
      return false;
    }
    Py_DECREF(field);
...
PyObject * ai_msgs__msg__roi__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("ai_msgs.msg._roi");
  ...
  {  // rect
    PyObject * field = NULL;
    field = sensor_msgs__msg__region_of_interest__convert_to_py(&ros_message->rect);
    if (!field) {
      return NULL;
    }
    {
      int rc = PyObject_SetAttrString(_pymessage, "rect", field);
      Py_DECREF(field);
      if (rc) {
        return NULL;
      }
