...
#define NODE_MAIN_LOGGER_NAME "hobot_codec_republish"
...
int main(int argc, char * argv[])
{
  ...
  std::string library_name = "libhobot_codec_component.so";
  std::string class_name = "rclcpp_components::NodeFactoryTemplate<HobotCodecNode>";
