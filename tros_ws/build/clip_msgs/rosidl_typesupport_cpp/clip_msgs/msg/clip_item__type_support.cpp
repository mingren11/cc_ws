...
static const _ClipItem_type_support_symbol_names_t _ClipItem_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, clip_msgs, msg, ClipItem)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, clip_msgs, msg, ClipItem)),
  }
};
...
{
  return &::clip_msgs::msg::rosidl_typesupport_cpp::ClipItem_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, clip_msgs, msg, ClipItem)() {
  return get_message_type_support_handle<clip_msgs::msg::ClipItem>();
}
