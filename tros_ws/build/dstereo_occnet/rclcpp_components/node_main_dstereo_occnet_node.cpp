...
#define NODE_MAIN_LOGGER_NAME "dstereo_occnet_node"
...
int main(int argc, char * argv[])
{
  ...
  std::string library_name = "libdstereo_occnet_component.so";
  std::string class_name = "rclcpp_components::NodeFactoryTemplate<DStereoOccNetNode>";
