...
bool performance_test__msg__array1k__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("performance_test.msg._array1k.Array1k", full_classname_dest, 37) == 0);
  }
  performance_test__msg__Array1k * ros_message = _ros_message;
  {  // array
...
{
  /* NOTE(esteve): Call constructor of Array1k */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("performance_test.msg._array1k");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "Array1k");
