...
#define NODE_MAIN_LOGGER_NAME "stereonet_model_component_node"
...
int main(int argc, char * argv[])
{
  ...
  std::string library_name = "libstereonet_model.so";
  std::string class_name = "rclcpp_components::NodeFactoryTemplate<stereonet::StereoNetNode>";
