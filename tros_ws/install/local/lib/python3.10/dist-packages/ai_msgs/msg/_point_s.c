...
bool ai_msgs__msg__point__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("ai_msgs.msg._point.Point", full_classname_dest, 24) == 0);
  }
  ai_msgs__msg__Point * ros_message = _ros_message;
  {  // type
  ...
  {  // point
    ...
    if (!geometry_msgs__msg__Point32__Sequence__init(&(ros_message->point), size)) {
      PyErr_SetString(PyExc_RuntimeError, "unable to create geometry_msgs__msg__Point32__Sequence ros_message");
      Py_DECREF(seq_field);
      Py_DECREF(field);
      return false;
    }
    geometry_msgs__msg__Point32 * dest = ros_message->point.data;
...
PyObject * ai_msgs__msg__point__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("ai_msgs.msg._point");
