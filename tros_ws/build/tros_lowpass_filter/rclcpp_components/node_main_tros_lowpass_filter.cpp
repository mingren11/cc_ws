...
#define NODE_MAIN_LOGGER_NAME "tros_lowpass_filter"
...
int main(int argc, char * argv[])
{
  ...
  std::string library_name = "libtros_lowpass_filter_component.so";
  std::string class_name = "rclcpp_components::NodeFactoryTemplate<tros::LowPassFilterNode>";
