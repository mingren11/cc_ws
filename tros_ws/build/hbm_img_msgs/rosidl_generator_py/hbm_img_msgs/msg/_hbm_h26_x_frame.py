...
class Metaclass_HbmH26XFrame(type):
    """Metaclass of message 'HbmH26XFrame'."""
    ...
    def __import_type_support__(cls):
        try:
            ...
            logger = logging.getLogger(
                'hbm_img_msgs.msg.HbmH26XFrame')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
            cls._CREATE_ROS_MESSAGE = module.create_ros_message_msg__msg__hbm_h26_x_frame
            cls._CONVERT_FROM_PY = module.convert_from_py_msg__msg__hbm_h26_x_frame
            cls._CONVERT_TO_PY = module.convert_to_py_msg__msg__hbm_h26_x_frame
            cls._TYPE_SUPPORT = module.type_support_msg__msg__hbm_h26_x_frame
            cls._DESTROY_ROS_MESSAGE = module.destroy_ros_message_msg__msg__hbm_h26_x_frame
    ...
    def MAX_SIZE(self):
        ...
        return Metaclass_HbmH26XFrame.__constants['MAX_SIZE']


class HbmH26XFrame(metaclass=Metaclass_HbmH26XFrame):
    """
    Message class 'HbmH26XFrame'.
    ...
    SLOT_TYPES = (
        ...
        rosidl_parser.definition.BasicType('uint32'),  # noqa: E501
        rosidl_parser.definition.BasicType('uint32'),  # noqa: E501
        rosidl_parser.definition.Array(rosidl_parser.definition.BasicType('uint8'), 512000),  # noqa: E501
        rosidl_parser.definition.BasicType('uint32'),  # noqa: E501
    )
    ...
    def __init__(self, **kwargs):
        ...
        if 'data' not in kwargs:
            self.data = numpy.zeros(512000, dtype=numpy.uint8)
        else:
            self.data = numpy.array(kwargs.get('data'), dtype=numpy.uint8)
            assert self.data.shape == (512000, )
    ...
    def data(self, value):
        if isinstance(value, numpy.ndarray):
            ...
            assert value.size == 512000, \
                "The 'data' numpy.ndarray() must have a size of 512000"
            self._data = value
            return
        if __debug__:
            from collections.abc import Sequence
            ...
            assert \
                ((isinstance(value, Sequence) or
                 ...
                 not isinstance(value, str) and
                 not isinstance(value, UserString) and
                 len(value) == 512000 and
                 all(isinstance(v, int) for v in value) and
                 all(val >= 0 and val < 256 for val in value)), \
                "The 'data' field must be a set or sequence with length 512000 and each value of type 'int' and each unsigned integer in [0, 255]"
