...
static const _HbmH26XFrame_type_support_symbol_names_t _HbmH26XFrame_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, hbm_img_msgs, msg, HbmH26XFrame)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, hbm_img_msgs, msg, HbmH26XFrame)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, hbm_img_msgs, msg, HbmH26XFrame)() {
  return &::hbm_img_msgs::msg::rosidl_typesupport_c::HbmH26XFrame_message_type_support_handle;
}
