...
#include "ai_msgs/msg/detail/roi__rosidl_typesupport_fastrtps_cpp.hpp"
  ...
  size_t current_alignment)
{
  ...
  current_alignment +=
    ...
    ros_message.rect, current_alignment);
  // Member: confidence
  {
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = ai_msgs::msg::Roi;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const ai_msgs::msg::Roi *>(
    untyped_ros_message);
...
{
  return &ai_msgs::msg::typesupport_fastrtps_cpp::_Roi__handle;
}
