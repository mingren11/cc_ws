...
void fetch_function__PerceptionTargets__perfs(
  const void * untyped_member, size_t index, void * untyped_value)
{
  const auto & item = *reinterpret_cast<const ai_msgs::msg::Perf *>(
    get_const_function__PerceptionTargets__perfs(untyped_member, index));
  auto & value = *reinterpret_cast<ai_msgs::msg::Perf *>(untyped_value);
  value = item;
}

void assign_function__PerceptionTargets__perfs(
  void * untyped_member, size_t index, const void * untyped_value)
{
  auto & item = *reinterpret_cast<ai_msgs::msg::Perf *>(
    get_function__PerceptionTargets__perfs(untyped_member, index));
...
void fetch_function__PerceptionTargets__targets(
  const void * untyped_member, size_t index, void * untyped_value)
{
  const auto & item = *reinterpret_cast<const ai_msgs::msg::Target *>(
    get_const_function__PerceptionTargets__targets(untyped_member, index));
  auto & value = *reinterpret_cast<ai_msgs::msg::Target *>(untyped_value);
  value = item;
}

void assign_function__PerceptionTargets__targets(
  void * untyped_member, size_t index, const void * untyped_value)
{
  auto & item = *reinterpret_cast<ai_msgs::msg::Target *>(
    get_function__PerceptionTargets__targets(untyped_member, index));
...
void fetch_function__PerceptionTargets__disappeared_targets(
  const void * untyped_member, size_t index, void * untyped_value)
{
  const auto & item = *reinterpret_cast<const ai_msgs::msg::Target *>(
    get_const_function__PerceptionTargets__disappeared_targets(untyped_member, index));
  auto & value = *reinterpret_cast<ai_msgs::msg::Target *>(untyped_value);
  value = item;
}

void assign_function__PerceptionTargets__disappeared_targets(
  void * untyped_member, size_t index, const void * untyped_value)
{
  auto & item = *reinterpret_cast<ai_msgs::msg::Target *>(
    get_function__PerceptionTargets__disappeared_targets(untyped_member, index));
  const auto & value = *reinterpret_cast<const ai_msgs::msg::Target *>(untyped_value);
  item = value;
}
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember PerceptionTargets_message_member_array[5] = {
  ...
  },
  {
    ...
    fetch_function__PerceptionTargets__perfs,  // fetch(index, &value) function pointer
    assign_function__PerceptionTargets__perfs,  // assign(index, value) function pointer
  ...
  },
  {
    ...
    fetch_function__PerceptionTargets__targets,  // fetch(index, &value) function pointer
    assign_function__PerceptionTargets__targets,  // assign(index, value) function pointer
  ...
  },
  {
    ...
    fetch_function__PerceptionTargets__disappeared_targets,  // fetch(index, &value) function pointer
    assign_function__PerceptionTargets__disappeared_targets,  // assign(index, value) function pointer
