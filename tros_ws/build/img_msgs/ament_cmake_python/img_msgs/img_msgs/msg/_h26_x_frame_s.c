...
bool img_msgs__msg__h26_x_frame__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("img_msgs.msg._h26_x_frame.H26XFrame", full_classname_dest, 35) == 0);
  }
  img_msgs__msg__H26XFrame * ros_message = _ros_message;
  {  // index
...
{
  /* NOTE(esteve): Call constructor of H26XFrame */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("img_msgs.msg._h26_x_frame");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "H26XFrame");
