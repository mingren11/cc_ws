...
class Metaclass_HbmMsg480P(type):
    """Metaclass of message 'HbmMsg480P'."""
    ...
    def __import_type_support__(cls):
        try:
            ...
            logger = logging.getLogger(
                'hbm_img_msgs.msg.HbmMsg480P')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
            cls._CREATE_ROS_MESSAGE = module.create_ros_message_msg__msg__hbm_msg480_p
            cls._CONVERT_FROM_PY = module.convert_from_py_msg__msg__hbm_msg480_p
            cls._CONVERT_TO_PY = module.convert_to_py_msg__msg__hbm_msg480_p
            cls._TYPE_SUPPORT = module.type_support_msg__msg__hbm_msg480_p
            cls._DESTROY_ROS_MESSAGE = module.destroy_ros_message_msg__msg__hbm_msg480_p
    ...
    def MAX_SIZE(self):
        ...
        return Metaclass_HbmMsg480P.__constants['MAX_SIZE']


class HbmMsg480P(metaclass=Metaclass_HbmMsg480P):
    """
    Message class 'HbmMsg480P'.
